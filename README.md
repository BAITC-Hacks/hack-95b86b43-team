...
с JSON/HTML-таблицей и тестами. API, PostgreSQL, миграции, worker и frontend пока остаются каркасом.
...
Следующий этап: сохраняемый импорт в PostgreSQL с диагностикой и версиями входов;
затем расширение расчётного ядра, подключение ИЭК к расчёту, API, интерфейс и полный сценарий утверждения.
